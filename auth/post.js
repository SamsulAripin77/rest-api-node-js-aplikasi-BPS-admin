                        ...
                        if (snapshot.exists()) {
                            ...
                            const cekAtasan = admin
                                    ...
                                    if (snapshot.exists()) {
                                        ...
                                        snapshot.forEach(function (childSnapshot) {
                                            ...
                                            if (deviceTokens === undefined) {
                                                ...
                                                console.log(
                                                    "image default: https://firebasestorage.googleapis.com/v0/b/sistempenggansipres" +
                                                    "ensi.appspot.com/o/Profile%2Fusers.png?alt=media&token=4fb53426-9874-464f-b814" +
                                                    "-ec4e3177d677"
                                                )
                                                ...
                                                admin
                                                    ...
                                                    .then(function (userRecord) {
                                                        ...
                                                        uid = userRecord.uid
                                                        imageUrl = "https://firebasestorage.googleapis.com/v0/b/sistempenggansipresensi.appspot.co" +
                                                                "m/o/Profile%2Fusers.png?alt=media&token=4fb53426-9874-464f-b814-ec4e3177d677"
                                                                    ...
                                                                    .then(function (value) {
                                                                        ...
                                                                        ref3
                                                                            .once('value', function (snapshot) {
                                                                                ...
                                                                                console.log(
                                                                                    '+++++++++++++++data dibawah adalah data yang baru saja ditambahkan ke databasa' +
                                                                                    'e'
                                                                                )
                                                                                console.log(data)
                                                                                res.send(data)
                                ...
                                .catch((error) => {
                                    console
                                        .log
                                        .json("eror di pencarian uid atasan l:", error)
                                    res.status(407)
                                    res.json(errorJson)
                                })
                            } else {
